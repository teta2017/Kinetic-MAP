clear all
clc
global a1 a2 R tspan Tfit tdat mOd mSd mGd has R2 m has2 IC
...
optN = optimset('MaxFunEvals',1e7,'MaxIter',1e7);
fteb = [0.5 0.5 0.5 0.5 1000 1000 1000 1000];
...
dmOdt = k1.*mB.^n1-k4.*mO.^n4;
dmCdt = k2.*mB.^n2;
dmGdt = k3.*mB.^n3+k4.*mO.^n4;
dmSdt = dmCdt+dmBdt;
