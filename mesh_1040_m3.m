...
global AL AG EaL EaG tspan Tfit tdat mOd mSd mGd has nL nG R2
global has2 m nS1 Si IC
AL = z(1);
AG = z(2);
EaL = z(3);
EaG = z(4);
...
global a1 a2 AL AG EaL EaG R nL nG
